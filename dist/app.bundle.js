...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__css_style_css__ = __webpack_require__(9);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__view__ = __webpack_require__(30);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__controller__ = __webpack_require__(32);





var model = Object(__WEBPACK_IMPORTED_MODULE_1__model__["a" /* default */])();
var controller = Object(__WEBPACK_IMPORTED_MODULE_3__controller__["a" /* default */])();
var view = Object(__WEBPACK_IMPORTED_MODULE_2__view__["a" /* default */])(controller);
...
function Model() {
  ...
  return {
    ...
    requestCurrentWeather: function requestCurrentWeather() {
      var _this = this;

      var url = "https://i34eo8f73h.execute-api.us-east-2.amazonaws.com/darksky/your-current-weather/" + this.myLatitude + "," + this.myLongitude;

      return __WEBPACK_IMPORTED_MODULE_0_axios___default.a.get(url).then(function (res) {
        _this.updateWeatherData(res.data);
      });
    },
    setCoordinates: function setCoordinates(lat, long) {
      this.myLatitude = lat;
      this.myLongitude = long;
    },
    updateWeatherData: function updateWeatherData(data) {
...
function View(controller) {
  return {
    ...
    fullSpinAnimation: function fullSpinAnimation(el) {
      el.classList.add('full-spin');
    },
    destroySplash: function destroySplash() {
    ...
    renderTimeout: function renderTimeout() {
      var temperatureContent = Object(__WEBPACK_IMPORTED_MODULE_0__utils__["a" /* html */])(_templateObject);
      this.temperature.innerHTML = temperatureContent;
      this.temperature.querySelector('.weather-viewer__reload-btn').addEventListener('click', this.pageReload);
    },
    renderWeatherView: function renderWeatherView(data) {
      var iconUseEl = this.pic.querySelector('use'),
    ...
    toggleUnit: function toggleUnit(data) {
      if (data.unit === 'F') {
...
function Controller() {
  ...
  return {
    ...
    getCurrentLocation: function getCurrentLocation() {
      navigator.geolocation.getCurrentPosition(this.ifLocationReceived.bind(this), this.ifGeolocationFails.bind(this), this.locationOptions);
    },
    ifLocationReceived: function ifLocationReceived(e) {
      var _this = this;

      this.model.setCoordinates(e.coords.latitude, e.coords.longitude);
      this.model.requestCurrentWeather().then(function () {
        _this.determineUnit();
        _this.view.destroySplash();
        _this.view.renderWeatherView(_this.model.getWeatherData());
      });
    },
    ifGeolocationFails: function ifGeolocationFails() {
      var _this2 = this;

      this.view.destroySplash();
      this.view.changeColorScheme(this.view.colors.timeout);
      setTimeout(function () {
        _this2.view.renderTimeout();
      }, 1400);
    },
    determineUnit: function determineUnit() {
