...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__css_style_css__ = __webpack_require__(28);
...
var view = {
  ...
  renderTimeout: function renderTimeout() {
    var temperatureContent = html(_templateObject);
...
var controller = {
  ...
  ifLocationReceived: function ifLocationReceived(e) {
    ...
    this.model.requestCurrentWeather().then(function () {
      _this3.determineUnit();
      _this3.view.destroySplash();
      _this3.view.renderWeatherView(_this3.model.getWeatherData());
    });
  },
